 ...
 *  2. put(key, value) - Set or insert the value if the key is not already
...
public class LRUCache {
    ...
    private LRUNode useHistoryHead;         // Points to the most recently used node
    private LRUNode useHistoryTail;         // Points to the least recently used node
